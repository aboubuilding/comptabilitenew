...
return new class extends Migration
{
    ...
    $table->foreignId('magasin_id')->nullable()->after('reference')->constrained('magasins');
    $table->decimal('total_ht', 12, 2)->nullable()->after('remise');
    ...
    $table->foreignId('client_id')->nullable()->constrained('clients'); // si clientèle externe
