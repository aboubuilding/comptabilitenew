...
@section('page_title')
    <i class="fas fa-flag"></i> Niveaux
@endsection

@section('page_actions')
    <div class="page-actions-wrapper">
        <button type="button" class="btn-btp btn-nouveau" data-bs-toggle="modal" data-bs-target="#niveauModal" id="btnNouveau">
...
@section('contenu')
    <div class="row">
        <div class="col-12">
            <div class="card-btp shadow-sm niveaux-card">
                <div class="card-header-btp bg-white border-0 py-4 px-4">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            ...
                            <select id="filterCycle" class="form-select filtre-input">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="search-wrapper">
                                ...
                                <input type="text" id="searchInput" class="form-control filtre-input search-input" placeholder="Libellé, description...">
                            </div>
                        </div>
                        <div class="col-md-3 text-end">
                            <span class="compteur-badge" id="niveauCount">0 niveau(x)</span>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-btp table-hover align-middle mb-0" id="niveauxTable">
                            <thead>
                            <tr>
                                <th><i class="fas fa-tag"></i> Libellé</th>
                                <th><i class="fas fa-layer-group"></i> Cycle</th>
                                <th><i class="fas fa-sort-numeric"></i> Ordre</th>
                                <th><i class="fas fa-align-left"></i> Description</th>
                                <th><i class="fas fa-power-off"></i> Statut</th>
                                <th class="text-center" style="width:100px;">Actions</th>
                            </tr>
                            </thead>
                            <tbody id="niveauxTbody"></tbody>
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="niveauModal" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="modalTitle"><i class="fas fa-plus-circle me-2"></i>Nouveau niveau</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-4">
                    <form id="niveauForm">
                        <input type="hidden" id="niveauId">
                            ...
                            <div class="col-md-8">
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="libelle" class="form-control" placeholder="Ex : 6ème, 5ème, 4ème..." required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <textarea id="description" class="form-control" rows="2" placeholder="Description du niveau"></textarea>
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label">Numéro d'ordre</label>
                                        <input type="number" id="numero_ordre" class="form-control" placeholder="1, 2, 3..." min="0">
                                        <small class="text-muted">Permet de trier les niveaux (1 = premier, 2 = deuxième, etc.)</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="cycle_id" class="form-control" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-enregistrer" id="saveNiveauBtn"><i class="fas fa-save me-1"></i> Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="detailModal" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="detailModalTitle"><i class="fas fa-circle-info me-2"></i>Détail niveau</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
...
@section('js')
    ...
    <script>
        window.niveauxConfig = {
            niveaux: @json($niveaux->toArray()),
            stats: @json($stats ?? []),
            cycles: @json($cycles->toArray()),
            routes: {
                store: "{{ route('niveaux.store') }}",
                update: "{{ route('niveaux.update', ['niveau' => ':id']) }}",
                destroy: "{{ route('niveaux.destroy', ['niveau' => ':id']) }}",
                toggleActive: "{{ route('niveaux.toggleActive', ['niveau' => ':id']) }}",
                show: "{{ route('niveaux.show', ['niveau' => ':id']) }}",
                stats: "{{ route('niveaux.stats') }}",
                getByCycle: "{{ route('niveaux.getByCycle') }}",
            }
        };
    </script>
    <script src="{{ asset('pages/niveau.js') }}"></script>
@endsection
