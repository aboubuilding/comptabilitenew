...
@section('page_actions')
    <div class="page-actions-wrapper">
        <button type="button" class="btn-btp btn-nouveau" data-bs-toggle="modal" data-bs-target="#userModal" id="btnNouveau">
...
@section('contenu')
    <div class="row">
        <div class="col-12">
            <div class="card-btp shadow-sm users-card">
                <div class="card-header-btp bg-white border-0 py-4 px-4">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            <label class="form-label filtre-label"><i class="fas fa-user-tag"></i> Rôle</label>
                            <select id="filterRole" class="form-select filtre-input">
                                <option value="">Tous</option>
                                <option value="1">Administrateur</option>
                                <option value="2">Directeur</option>
                                <option value="3">Comptable</option>
                                <option value="4">Admin Adjoint</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="search-wrapper">
                                ...
                                <input type="text" id="searchInput" class="form-control filtre-input search-input" placeholder="Nom, prénom, login...">
                            </div>
                        </div>
                        <div class="col-md-3 text-end">
                            <span class="compteur-badge" id="userCount">0 utilisateur(s)</span>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-btp table-hover align-middle mb-0" id="usersTable">
                            <thead>
                            <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="modalTitle"><i class="fas fa-user-plus me-2"></i>Nouvel utilisateur</h5>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-section">
                                    <div class="form-section-title"><i class="fas fa-id-card"></i> Identité</div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="login" class="form-control" placeholder="Identifiant" required>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="mot_passe" class="form-control" placeholder="••••••••" minlength="6">
                                        <small class="text-muted">Minimum 6 caractères</small>
                                    </div>
                                    <div class="mb-3" id="confirmPasswordGroup">
                                        <label class="form-label">Confirmer le mot de passe <span class="text-danger">*</span></label>
                                        <input type="password" id="mot_passe_confirmation" class="form-control" placeholder="••••••••">
                                    </div>
                                    <div class="mb-0">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-enregistrer" id="saveUserBtn"><i class="fas fa-save me-1"></i> Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="detailModal" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="detailModalTitle"><i class="fas fa-circle-info me-2"></i>Détail utilisateur</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                ...
                <div class="modal-body p-4">
                    <form id="passwordForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" id="new_password" class="form-control" placeholder="••••••••" minlength="6" required>
                            <small class="text-muted">Minimum 6 caractères</small>
                        </div>
                        <div class="mb-0">
                            <label class="form-label">Confirmer <span class="text-danger">*</span></label>
                            <input type="password" id="new_password_confirmation" class="form-control" placeholder="••••••••" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-annuler" data-bs-dismiss="modal">Annuler</button>
                    <button type="button" class="btn btn-enregistrer" id="savePasswordBtn"><i class="fas fa-save me-1"></i> Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
...
@section('css')
    <style>
        ...
        /* "Actif" reste vert pour rester intuitif — l'accent doré est
           réservé aux éléments de marque (toast, icônes de titre...). */
...
@section('js')
    ...
    <script>
        window.usersConfig = {
            users: @json($users->toArray()),
            stats: @json($stats ?? []),
            routes: {
                store: "{{ route('users.store') }}",
                update: "{{ route('users.update', ['user' => ':id']) }}",
                destroy: "{{ route('users.destroy', ['user' => ':id']) }}",
                toggleActive: "{{ route('users.toggleActive', ['user' => ':id']) }}",
                show: "{{ route('users.show', ['user' => ':id']) }}",
                changePassword: "{{ route('users.changePassword', ['user' => ':id']) }}",
