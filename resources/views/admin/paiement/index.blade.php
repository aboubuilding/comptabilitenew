                        ...
                        <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example">
                            ...
                            @foreach( $data as $paiement  )
                                ...
                                <tr>
                                    ...
                                    <td><h6 class="mb-0">{{ $paiement ['inscription']->niveau->libelle }} </h6></td>
                                    <td><h6 class="mb-0">
                                    ...
                                    <td><h6 class="mb-0">{{ $paiement ['utilisateur']->nom }} {{ $paiement ['utilisateur']->prenom }}</h6></td>
                                        ...
                                        <div class="d-flex">
                                            <div class="dropdown custom-dropdown ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item detailPaiement" href="" data-id="{{$paiement['id']}}">Voir détail </a>

                                                    @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::NON_ENCAISSE)
                                                        <a class="dropdown-item supprimerPaiement" href="#"  data-id="{{$paiement['id']}}">Supprimer</a>
