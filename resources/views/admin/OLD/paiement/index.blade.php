...
@section('title')
    ...
    Comptabilite | Tous les  paiements
@endsection
...
@section('contenu')
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="chart-num">
                                                ...
                                                <h2 class="font-w700 mb-0">
                                                    ...
                                                    {{ number_format($total__montant_mois, 0, ',', ' ') }}
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="chart-num">
                                                ...
                                                <h2 class="font-w700 mb-0">
                                                    ...
                                                    {{ number_format($total__montant_semaine, 0, ',', ' ') }}
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="chart-num">
                                                ...
                                                <h2 class="font-w700 mb-0">
                                                    ...
                                                    {{ number_format($total__montant_jour, 0, ',', ' ') }}
                        ...
                        <div class="col-xl-12">
                            <div class="page-title flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a href="{{url('/paiements/add')}}" type="button" href="#" id="lancerPaiement"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="trans-list">
                                                    ...
                                                    <h4>{{ $paiement ['inscription']->eleve->nom }} {{ $paiement ['inscription']->eleve->prenom }}</h4>
                                                </div>
                                            </td>

                                            <td><h6 class="mb-0">{{ $paiement ['inscription']->niveau->libelle }} </h6>
                                            </td>
                                            <td><h6 class="mb-0">
                                            ...
                                            <td>
                                                <h6 class="mb-0">
                                                    ...
                                                    @if($paiement ['mode_paiement'] === \App\Types\ModePaiement::CHEQUE)
                                                        Chèque
                                                    @endif

                                                </h6>
                                            </td>
                                            <td><h6 class="mb-0">{{ $paiement ['date_paiement'] }} </h6></td>

                                            <td>

                                                @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::NON_ENCAISSE)
                                                ...
                                                @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::ENCAISSE)
                                                ...
                                                @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::EN_ATTENTE_ANNULATION)
                                                ...
                                                @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::ANNULES)
                                            ...
                                            @if( $role == \App\Types\Role::DIRECTEUR || $role == \App\Types\Role::ADMIN )
                                                ...
                                                <td>
                                                    <h6 class="mb-0">{{ $paiement ['utilisateur']->nom }} {{ $paiement ['utilisateur']->prenom }}</h6>
                                                </td>
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item detailPaiement" href=""
                                                               data-id="{{$paiement['id']}}">Voir détail </a>

                                                            @if($paiement ['statut_paiement'] === \App\Types\StatutPaiement::NON_ENCAISSE)
                                                                <a class="dropdown-item supprimerPaiement" href="#"
                                                                   data-id="{{$paiement['id']}}">Supprimer</a>
    ...
    @include('admin.paiement.modaldetail')
