                                    ...
                                    @foreach( $data as $niveau )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierNiveau"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$niveau['id']}}" title="Modifier "
                                                       data-id="{{$niveau['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerNiveau"
                                                       data-id="{{$niveau['id']}}" title="Supprimer "><i
