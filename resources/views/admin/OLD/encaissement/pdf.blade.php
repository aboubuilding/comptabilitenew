...
<body>
    ...
    <div id="container">
        ...
        <div id="bloc1">
            ...
            <br><br>
            @if ($paiement->inscription->taux_remise > 0 || $paiement->inscription->taux_remise != null)
                <p>Vous avez obtenu une réduction de <strong>{{ $paiement->inscription->taux_remise }}%</strong> sur la
                    scolarité qui vous revient à
                    <strong>{{ number_format($montant_scolarite - ($montant_scolarite * $paiement->inscription->taux_remise) / 100, 0, ',', ' ') }}
                        Francs CFA</strong></p>
            @endif
            <br><br>
            <div id="note">
