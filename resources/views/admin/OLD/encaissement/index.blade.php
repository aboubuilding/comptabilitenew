                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item detailEncaissement" href=""
                                                               data-id="{{$encaissement['id']}}">Voir détail </a>
                                                            <a class="dropdown-item"
                                                               href="{{ route('encaissement_pdf', ['id' => $encaissement['id']]) }}">Imprimer</a>


                                                            <a class="dropdown-item demanderAnnulation" href="#"
                                                               data-id="{{$encaissement['id']}}">Demander
                                                                annulation </a>
