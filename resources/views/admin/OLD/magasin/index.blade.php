                                    ...
                                    @foreach( $data as $magasin )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierMagasin"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$magasin['id']}}" title="Modifier "
                                                       data-id="{{$magasin['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerMagasin"
                                                       data-id="{{$magasin['id']}}" title="Supprimer "><i
