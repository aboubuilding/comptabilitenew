                                    ...
                                    @foreach( $data as $zone )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierZone"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$zone['id']}}" title="Modifier "
                                                       data-id="{{$zone['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#" class="btn btn-danger shadow btn-xs sharp supprimerZone"
                                                       data-id="{{$zone['id']}}" title="Supprimer "><i
