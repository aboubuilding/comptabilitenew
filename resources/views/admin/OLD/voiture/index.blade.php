                                    ...
                                    @foreach( $data as $voiture )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierVoiture"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$voiture['id']}}" title="Modifier "
                                                       data-id="{{$voiture['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerVoiture"
                                                       data-id="{{$voiture['id']}}" title="Supprimer "><i
