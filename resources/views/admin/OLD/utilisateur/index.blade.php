                                    ...
                                    @foreach( $data as $utilisateur )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierUtilisateur"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$utilisateur['id']}}" title="Modifier "
                                                       data-id="{{$utilisateur['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerUtilisateur"
                                                       data-id="{{$utilisateur['id']}}" title="Supprimer "><i
