                                    ...
                                    @foreach( $data as $classe )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierClasse"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$classe['id']}}" title="Modifier "
                                                       data-id="{{$classe['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerClasse"
                                                       data-id="{{$classe['id']}}" title="Supprimer "><i
