                            ...
                            <div class="content-box">
                                ...
                                <div class="chart-num">
                                    ...
                                    <h2 class="font-w700 mb-0">
                                        ...
                                        {{ number_format($total_cantine_gouter, 0, ',', ' ') }}
                            ...
                            <div class="content-box">
                                ...
                                <div class="chart-num">
                                    ...
                                    <h2 class="font-w700 mb-0">
                                        ...
                                        {{ number_format($total_cantine_dejeuner, 0, ',', ' ') }}
                            ...
                            <div class="content-box">
                                ...
                                <div class="chart-num">
                                    ...
                                    <h2 class="font-w700 mb-0">
                                        ...
                                        {{ number_format($total_ont_payer, 0, ',', ' ') }}
                        ...
                        <div class="col-xl-12">
                            <div class="page-title flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a href="" target="_blank" type="button" href="#" id="exportPDF"
                                       class="btn btn-rounded btn-info">
                                        <span class="btn-icon-start text-info"><i class="fa fa-file color-info"></i>Exporter en PDF</span>

                                    </a>


                                    <a href="" target="_blank" type="button" href="#" id="exportExcel"
                                       class="btn btn-rounded btn-info">
                                        <span class="btn-icon-start text-info"><i class="fa fa-file color-info"></i>Exporter en Excel </span>
                                ...
                                <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer"
                                    ...
                                    @foreach( $data as $souscription  )
                                        ...
                                        <tr>
                                            ...
                                            <td><h6 class="mb-0">{{ $souscription ['cycle'] }} </h6></td>
                                            <td><h6 class="mb-0">{{ $souscription ['niveau'] }} </h6></td>
                                            <td><h6 class="mb-0">{{ $souscription ['offre'] }} </h6></td>
                                            <td><h6 class="mb-0">

                                                    {{ $souscription ['total_a_payer']}}
                                            ...
                                            <td><h6 class="mb-0">
                                                    ...
                                                    {{ $souscription ['montant_deja_paye'] }}
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item detailOffre" href=""
                                                               data-id="{{$souscription['id']}}">Voir les paiements </a>


                                                            <a class="dropdown-item modifierOffre" href=""
                                                               data-id="{{$souscription['id']}}">Modifier offre </a>
...
@section('js')
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            //------------------------ Frmer la fenetre de modification de l offre
            $("#annulerOffre").click(function (event) {
            ...
            //------------------------ Frmer la fenetre d afficher la page de details
            $("#annulerDetail").click(function (event) {
                event.preventDefault();
            ...
            $(document).on('click', '.modifierOffre', function (e) {

                e.preventDefault();

                let id = $(this).data('id');
                let url = "/cantine/modifier/" + id;
                ...
                $.get(url, function (data) {
                    ...
                    $('#defaultModalLabel').text('Modifier l offre      ');

                    let modification_modal = $('#modifierOffre');

                    $(modification_modal).find('form').find('input[name="eleve"]').val(data.eleve);


                    $(modification_modal).find('form').find('input[name="niveau"]').val(data.niveau);
                    $(modification_modal).find('form').find('input[name="cycle"]').val(data.cycle);

                    $(modification_modal).find('form').find('select[name="frais_ecole_id"]').val(data.frais);
            ...
            //------------------------ Afficher le  detail de paiements de la cantine
            $(document).on('click', '.detailOffre', function (event) {


                event.preventDefault();
                let id = $(this).data('id');
                let url = "/cantine/souscriptions/details/" + id;
                ...
                $.get(url, function (data) {
                    ...
                    $('#defaultModalLabel').text('Détail paiement pour la cantine       ');

                    let detail_modal = $('#detailOffre');


                    $(detail_modal).find('form').find('input[name="eleve"]').val(data.eleve);
                    $(detail_modal).find('form').find('input[name="niveau"]').val(data.niveau);

                    $(detail_modal).find('form').find('input[name="cycle"]').val(data.cycle);
                    ...
                    for (let i = 0; i < details.length; i++) {
                        ...
                        output += `
                            ...
                            <td data-id="${details[i].id}">${index}</td>
                               ...
                               <td>${details[i].reference}</td>
                            <td>${details[i].payeur}</td>
                            <td>${details[i].montant}</td>
                            <td>${details[i].date_paiement}</td>
            ...
            $("#validerModifier").click(function (event) {
                event.preventDefault();
        ...
        //------------------------ Fermer  le popup de modification de l offre
        function annulerOffre() {


            $('#detailOffre').modal('toggle');
        }

        //------------------------ Fermer  le popup de detail
        function annulerDetail() {
        ...
        function validerModifier() {
            ...
            let offre = parseInt($("#frais_ecole_id").val(), 10);

            if (isNaN(offre) || offre === 0) {
                $('.frais_ecole_id_error').text("Le montant     est obligatoire ");
                allValid = false;
            ...
            if (allValid) {
                ...
                $.ajax({
                    dataType: 'json',
                    type: 'POST',
                    url: "/cantine/souscriptions/update/" + id,
