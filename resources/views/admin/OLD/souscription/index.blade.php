                        ...
                        <div class="col-xl-12">
                            <div class="page-title flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a href="{{url('/souscriptions/add')}}" type="button" href="#"
                                       id="lancerSouscription" class="btn btn-rounded btn-info"><span
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item detailSouscription" href=""
                                                               data-id="{{$souscription['id']}}">Voir détail </a>


                                                            <a class="dropdown-item supprimerSouscription" href="#"
                                                               data-id="{{$souscription['id']}}">Supprimer</a>
