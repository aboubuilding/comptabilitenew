                                    ...
                                    @foreach( $data as $chauffeur )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierChauffeur"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$chauffeur['id']}}" title="Modifier "
                                                       data-id="{{$chauffeur['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerChauffeur"
                                                       data-id="{{$chauffeur['id']}}" title="Supprimer "><i
