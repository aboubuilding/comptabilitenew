...
@section('contenu')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="trans-list">
                                                    ...
                                                    <h4>{{ $paiement ['nom_eleve'] }}</h4>
                                                </div>
                                            </td>

                                            <td><h6 class="mb-0">{{ $paiement ['niveau'] }} </h6></td>
                                            <td><h6 class="mb-0">
    ...
    @include('admin.OLD.paiement.modal')
    @include('admin.OLD.paiement.modaldetail')
