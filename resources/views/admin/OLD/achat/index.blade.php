                        ...
                        <div class="col-xl-12">
                            <div class="page-title flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a type="button" href="{{ url('/achats/add') }}"
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item detailachat" href=""
                                                               data-id="{{$achat['id']}}">Voir détail </a>

                                                            <a class="dropdown-item supprimerachat" href="#"
                                                               data-id="{{$achat['id']}}">Supprimer</a>
