                        ...
                        <div class="row">
                            ...
                            <div class="default-tab">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link " data-bs-toggle="tab" href="#produits"><i
                                    ...
                                    <div class="tab-pane fade show active" id="produit">
                                        ...
                                        <div class="row" id="liste_produit">
                                                    ...
                                                    <select class="default-select col-xl-12" id="produit_id"
                                                        ...
                                                        @foreach( $produits  as $produit )
                                                            ...
                                                            <option value="{{$produit->id}}"
                                                                    data-prix_unitaire="{{$produit->montant}}">  {{$produit->libelle }}
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <span
                                                    class="text-danger error-text montant_ligne_produit_error"> </span>
