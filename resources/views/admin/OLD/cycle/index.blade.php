                                    ...
                                    @foreach( $data as $cycle )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierCycle"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$cycle['id']}}" title="Modifier "
                                                       data-id="{{$cycle['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerCycle"
                                                       data-id="{{$cycle['id']}}" title="Supprimer "><i
