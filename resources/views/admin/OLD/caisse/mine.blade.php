...
@section('title')
    ...
    Comptabilité | Mes caisses

@endsection

@section('titre')
    Liste de mes caisses
@endsection
                                ...
                                <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer"
                                    ...
                                    @foreach( $data as $caisse )
                                        ...
                                        <tr>
                                            ...
                                            <td><h6 class="mb-0">{{ $caisse['solde_initial'] }} </h6></td>
                                            <td><h6 class="mb-0">{{ $caisse['solde_final'] }} </h6></td>
                                            <td><h6 class="mb-0">{{ $caisse['total_encaissement'] }} </h6></td>

                                            <td>

                                                @if($caisse ['statut'] === \App\Types\StatutCaisse::OUVERT)

                                                    <span class="badge badge-success light badge-sm">Ouvert<span
                                                ...
                                                @if($caisse ['statut'] === \App\Types\StatutCaisse::CLOTURE)
                                                    ...
                                                    <span class="badge badge-primary light badge-sm">Cloturée  <span
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="{{url('/caisses/detail/'.$caisse['id'])}}"
                                                       class="btn btn-success shadow btn-xs sharp me-1 detailCaisse"
                                                       style="background-color: #1EA1F3; border: red"
                                                       data-id="{{$caisse['id']}}" title="Details des mouvements  "
                                                       data-id="{{$caisse['id']}}"><i class="fa fa-plus"></i></a>


                                                    @if($caisse['total_encaissement'] == 0)
                                                        <a href="#"
                                                           class="btn btn-danger shadow btn-xs sharp me-1 supprimerCaisse"
                                                           style="background-color: red; border: #1EA1F3"
                                                           data-id="{{$caisse['id']}}" title="Supprimer "><i
                                                    ...
                                                    @if($caisse['statut'] == \App\Types\StatutCaisse::OUVERT)
                                                        ...
                                                        <a href="#"
                                                           class="btn btn-primary shadow btn-xs sharp me-1 modifierCaisse"
                                                           style="background-color: #0e5a2f; border: #1EA1F3"
                                                           data-id="{{$caisse['id']}}" title="Modifier "
                                                           data-id="{{$caisse['id']}}"><i class="fa fa-pencil"></i></a>
...
@section('js')
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click', '.modifierCaisse', function () {
                ...
                $.get(url, function (data) {
                    ...
                    $("#addCaisse #ajouterCaisse").hide();
                    $("#addCaisse #updateCaisse").show();
        ...
        function clearData() {
            ...
            $("#addCaisse #ajouterCaisse").show();
            $("#addCaisse #updateCaisse").hide();
