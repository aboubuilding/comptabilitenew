                        ...
                        <div class="col-xl-12">
                            <div class="page-title flex-wrap">
                                ...
                                <div>
                                    @php
                                        $disabled = 'disabled';
                                        if ($annee->statut_annee == \App\Types\StatutAnnee::OUVERT) {
                                            $disabled = '';
                                        }
                                    @endphp

                                            <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" {{ $disabled }} id="lancerCaisse">
                                        + Caisse
                                    </button>
                                </div>
                            </div>
                                ...
                                <table
                                    ...
                                    @foreach ($data as $caisse)
                                        <tr>
                                            ...
                                            @if ($role == \App\Types\Role::DIRECTEUR || $role == \App\Types\Role::ADMIN)
                                                <td>
                                                    <h6 class="mb-0">{{ $caisse['responsable'] }} </h6>
                                                </td>
                                            @endif
...
@section('js')
    ...
    <script>
        ...
        function clearData() {
            ...
            const formatted = today.toISOString().split('T')[0]; // Y-m-d
            const result = "Caisse-" + formatted;
