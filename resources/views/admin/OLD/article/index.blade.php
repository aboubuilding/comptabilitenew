                                    ...
                                    @foreach( $data as $article )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierArticle"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$article['id']}}" title="Modifier "
                                                       data-id="{{$article['id']}}"><i class="fa fa-pencil"></i></a>

                                                    @if( $article['total_article'] == 0)
                                                        <a href="#"
                                                           class="btn btn-danger shadow btn-xs sharp supprimerArticle"
                                                           data-id="{{$article['id']}}" title="Supprimer "><i
