                                    ...
                                    @foreach( $data as $produit )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierProduit"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$produit['id']}}" title="Modifier "
                                                       data-id="{{$produit['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerProduit"
                                                       data-id="{{$produit['id']}}" title="Supprimer "><i
