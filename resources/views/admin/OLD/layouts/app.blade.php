...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Kumbh+Sans:wght@300;400;500;600;700;800&family=Playfair+Display:wght@600;700&display=swap"
        rel="stylesheet">
...
{{-- Topbar avec logo --}}
@include('admin.OLD.layouts.partials.nav-header')

{{-- Menu horizontal --}}
@include('admin.OLD.layouts.partials.nav-menu')
