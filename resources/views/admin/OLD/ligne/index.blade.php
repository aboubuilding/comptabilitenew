                                    ...
                                    @foreach( $data as $ligne )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierLigne"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$ligne['id']}}" title="Modifier "
                                                       data-id="{{$ligne['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerLigne"
                                                       data-id="{{$ligne['id']}}" title="Supprimer "><i
