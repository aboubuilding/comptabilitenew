                                    ...
                                    @foreach( $data as $fraisecole  )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierFraisecole"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$fraisecole ['id']}}" title="Modifier "
                                                       data-id="{{$fraisecole ['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerFraisecole"
                                                       data-id="{{$fraisecole ['id']}}" title="Supprimer "><i
