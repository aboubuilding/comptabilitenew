                                    ...
                                    @foreach( $data as $fournisseur )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                       class="btn btn-primary shadow btn-xs sharp me-1 modifierFournisseur"
                                                       style="background-color: #1EA1F3; border: #1EA1F3"
                                                       data-id="{{$fournisseur['id']}}" title="Modifier "
                                                       data-id="{{$fournisseur['id']}}"><i class="fa fa-pencil"></i></a>
                                                    <a href="#"
                                                       class="btn btn-danger shadow btn-xs sharp supprimerFournisseur"
                                                       data-id="{{$fournisseur['id']}}" title="Supprimer "><i
