                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <table class="table table-bordered text-center mb-0">
                                    <thead class="table-light fw-bold text-uppercase" style="font-size: 16px;">
                                        <tr>
                                            <th>Type Paiement</th>
                                    ...
                                    <tbody style="font-size: 17px; font-weight: 500;">
                                        <tr>
                                            <td><strong>Scolarité</strong></td>
                                            <td class="text-primary">
                                                <strong>{{ number_format($total_scolarite_previsionnelle, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-success">
                                                <strong>{{ number_format($total_scolarite, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-danger">
                                                <strong>{{ number_format($total_reste_scolarite, 0, ',', ' ') }}</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Cantine</strong></td>
                                            <td class="text-primary">
                                                <strong>{{ number_format($cantine_previsionnelle, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-success">
                                                <strong>{{ number_format($total_cantine, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-danger">
                                                <strong>{{ number_format($cantine_previsionnelle - $total_cantine, 0, ',', ' ') }}</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Bus</strong></td>
                                            <td class="text-primary">
                                                <strong>{{ number_format($bus_previsionnelle, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-success">
                                                <strong>{{ number_format($total_bus, 0, ',', ' ') }}</strong>
                                            </td>
                                            <td class="text-danger">
                                                <strong>{{ number_format($bus_previsionnelle - $total_bus, 0, ',', ' ') }}</strong>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-danger">
                                                <strong>
                                                    {{ number_format(
                                                        $total_scolarite_previsionnelle -
                                                            $total_scolarite +
                                        ...
                                        <tr>
                                            <td><strong>Total des rémises</strong></td>
                                            <td class="text-primary" colspan="3">
                                                <strong>{{ number_format($total_remise, 0, ',', ' ') }}</strong>
                                            </td>
                                        </tr>
                                ...
                                <div class="basic-list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex justify-content-between align-items-center"
                                            ...
                                            Scolarité encaissée <span class="badge badge-primary badge-pill">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center"
                                            style="color: black; font-size:16px">
                                            Scolarité prévisionnelle <span class="badge badge-primary badge-pill">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="date" name="search_date" id="search_date"
                                                placeholder="Rechercher..." value="{{ $search_date }}"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div>
