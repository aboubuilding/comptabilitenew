{{-- resources/views/admin/cycles/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Cycles')

@section('page_title')
    <i class="fas fa-layer-group"></i> Cycles
@endsection

@section('page_actions')
    <div class="page-actions-wrapper">
        <button type="button" class="btn-btp btn-nouveau" data-bs-toggle="modal" data-bs-target="#cycleModal" id="btnNouveau">
...
@section('contenu')
    <div class="row">
        <div class="col-12">
            <div class="card-btp shadow-sm cycles-card">
                <div class="card-header-btp bg-white border-0 py-4 px-4">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3 text-end">
                            <span class="compteur-badge" id="cycleCount">0 cycle(s)</span>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-btp table-hover align-middle mb-0" id="cyclesTable">
                            <thead>
                            <tr>
    ...
    <div class="modal fade" id="cycleModal" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="modalTitle"><i class="fas fa-plus-circle me-2"></i>Nouveau cycle</h5>
                    ...
                    <form id="cycleForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="libelle" class="form-control" placeholder="Ex : Primaire, Secondaire..." required>
                            </div>
                            <div class="mb-0">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-enregistrer" id="saveCycleBtn"><i class="fas fa-save me-1"></i> Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="detailModal" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content modal-btp">
                <div class="modal-header modal-header-btp">
                    <h5 class="modal-title" id="detailModalTitle"><i class="fas fa-circle-info me-2"></i>Détail cycle</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
    ...
    <script>
        window.cyclesConfig = {
            ...
            routes: {
                ...
                update: "{{ route('cycles.update', ['cycle' => ':id']) }}",
                destroy: "{{ route('cycles.destroy', ['cycle' => ':id']) }}",
                toggleActive: "{{ route('cycles.toggleActive', ['cycle' => ':id']) }}",
                show: "{{ route('cycles.show', ['cycle' => ':id']) }}",
                stats: "{{ route('cycles.stats') }}",
            }
        };
    </script>
    <script src="{{ asset('pages/cycle.js') }}"></script>
@endsection
